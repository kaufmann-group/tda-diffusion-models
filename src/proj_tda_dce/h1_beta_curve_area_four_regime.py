"""
Checkpointed four-regime DCE test using h1_beta_curve_area_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_h1_beta_curve_area_four_regimes"
    output_filename = "h1_beta_curve_area_four_regimes.png"
    suptitle = r"$H_1$ Beta Curve Area Relaxation Time Scaling"
