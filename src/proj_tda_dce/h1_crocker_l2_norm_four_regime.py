"""
Checkpointed four-regime DCE test using h1_crocker_l2_norm_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_h1_crocker_l2_norm_four_regimes"
    output_filename = "h1_crocker_l2_norm_four_regimes.png"
    suptitle = r"$H_1$ CROCKER $L^2$ Norm Relaxation Time Scaling"
