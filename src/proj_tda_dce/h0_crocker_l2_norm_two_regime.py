"""
Checkpointed two-regime DCE test using h0_crocker_l2_norm_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_h0_crocker_l2_norm_two_regimes"
    output_filename = "h0_crocker_l2_norm_two_regimes.png"
