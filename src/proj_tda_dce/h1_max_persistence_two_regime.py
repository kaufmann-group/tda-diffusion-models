"""
Checkpointed two-regime DCE test using h1_max_persistence_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_h1_max_persistence_two_regimes"
    output_filename = "h1_max_persistence_two_regimes.png"
