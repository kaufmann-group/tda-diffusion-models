"""
Checkpointed four-regime DCE test using h0_entropy_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_h0_entropy_four_regimes"
    output_filename = "h0_entropy_four_regimes.png"
    suptitle = r"$H_0$ Entropy Relaxation Time Scaling"
