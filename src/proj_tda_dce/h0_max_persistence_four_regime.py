"""
Checkpointed four-regime DCE test using h0_max_persistence_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_h0_max_persistence_four_regimes"
    output_filename = "h0_max_persistence_four_regimes.png"
