"""
Checkpointed two-regime DCE test using h1_entropy_from_points.
"""
...
if __name__ == "__main__":
    ...
    process_name = "raw_projection_raw_projection_h1_entropy_two_regimes"
    output_filename = "h1_entropy_two_regimes.png"
